...
from analysis_point import generate_pdf_report
import numpy as np
def main():
    # Read Video
    input_video_path = "input_videos/input_video_test3.mp4"
    ...
    player_detections = player_tracker.detect_frames(video_frames,
                                                     read_from_stub=True,
                                                     stub_path="tracker_stubs/player_detections_test3.pkl"
                                                     )
    ball_detections = ball_tracker.detect_frames(video_frames,
                                                     read_from_stub=True,
                                                     stub_path="tracker_stubs/ball_detections_test3.pkl"
                                                     )
    ...
    # Draw Player Stats
    output_video_frames = draw_player_stats(output_video_frames,player_stats_data_df,player_1,player_2)
    ...
    ## Draw court Keypoints
    output_video_frames  = court_line_detector.draw_keypoints_on_video(output_video_frames, court_keypoints)'''
    #generate_pdf_report(player_1, player_2, csv_file="game_report.csv", output_pdf="tennis_match_report.pdf")
    save_video(output_video_frames, "output_videos/output_video_test3.avi")
